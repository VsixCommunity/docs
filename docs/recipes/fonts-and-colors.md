...
## [Step 1 — Define a category](#define-a-category)
...
## [Step 2 — Define a provider](#define-a-provider)
...
## [Step 3 — Register in the package](#register-in-package)
...
## [Reading configured colors at runtime](#reading-colors)
