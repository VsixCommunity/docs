...
## [Package did not load correctly](#package-not-loaded)
...
## [Extension doesn't appear after building](#extension-not-appearing)
...
## [Reset the Experimental Instance](#reset-experimental)
...
## [Command doesn't show up in menus](#command-not-visible)
...
## [MEF component not found](#mef-not-found)
...
## [Build errors after updating packages](#build-errors)
...
## [Extension works in Experimental but not after install](#works-in-exp-only)
